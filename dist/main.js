...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.retrieve = undefined;

	var _managedRecords = __webpack_require__(330);

	var _managedRecords2 = _interopRequireDefault(_managedRecords);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.retrieve = _managedRecords2.default;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _fetchFill = __webpack_require__(331);

	var _fetchFill2 = _interopRequireDefault(_fetchFill);

	var _urijs = __webpack_require__(333);
	...
	var RequestHandler = {
	   ...
	   * @return {number} Limit
	   */
	  resolveLimit: function resolveLimit() {
	   ...
	   * @return {number} Records offset
	   */
	  resolveOffset: function resolveOffset() {
	    var page = 'number' === typeof this.options.page ? parseInt(this.options.page) : defaultRequestOptions.page;
	   ...
	   */
	  resolvePayload: function resolvePayload() {
	 ...
	 */
	var generateApiGetRequest = function generateApiGetRequest(path) {
	  var payload = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

	  return (0, _urijs2.default)(path).search(payload);
	};
	 ...
	 * @return {string}         Generated records endpoint
	 */
	var formApiRequest = function formApiRequest() {
	  var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

	  var payload = RequestHandler.resolvePayload(options);
	...
	var request = function request() {
	  ...
	  var uri = formApiRequest(options);

	  return (0, _fetchFill2.default)(uri).then(function (response) {
	    if (response.ok) {
	 ...
	 */
	var requestPages = function requestPages() {
	  var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

	  var currentPage = options.page || defaultRequestOptions.page;

	  /*
	  current (desired `retrieve`) page
	   */
	  var current = request(options).then(function (response) {
	    return response;
	  }).catch(function (error) {
	    return console.log('Error: ', error.message);
	  });
	   ...
	   */
	  var previous = peek(options, currentPage - 1).then(function (response) {
	    return response && response.length > 0 ? currentPage - 1 : null;
	  }).catch(function (error) {
	    return console.log('Error: ', error.message);
	  });
	   ...
	   */
	  var next = peek(options, currentPage + 1).then(function (response) {
	    return response && response.length > 0 ? currentPage + 1 : null;
	  }).catch(function (error) {
	    return console.log('Error: ', error.message);
	  });

	  return Promise.all([current, previous, next]).then(function (responses) {
	...
	var ResponseHandler = {
	   ...
	   */
	  deriveAndAmendIsPrimary: function deriveAndAmendIsPrimary() {
	    return this.response.map(function (record) {
	   ...
	   */
	  resolveOpen: function resolveOpen() {
	   ...
	   */
	  resolveClosedPrimaryCount: function resolveClosedPrimaryCount() {
	    return this.response.filter(function (record) {
	   ...
	   */
	  resolveResponse: function resolveResponse() {
	...
	var transformResponse = function transformResponse() {
	  ...
	  var transformedResponse = ResponseHandler.resolveResponse(response, options);
	...
	var retrieve = function retrieve() {
	  ...
	  return requestPages(options).then(function (response) {
	...
	retrieved.then(function (response) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _fetchPonyfill = __webpack_require__(332);

	var _fetchPonyfill2 = _interopRequireDefault(_fetchPonyfill);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var fetchFill = (0, _fetchPonyfill2.default)({ Promise: Promise });
	exports.default = fetchFill.fetch;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function (root, factory) {
	  ...
	  if (typeof module === 'object' && module.exports) {
	    // Node
	    module.exports = factory(__webpack_require__(334), __webpack_require__(336), __webpack_require__(337));
	  } else if (true) {
	    // AMD. Register as an anonymous module.
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(334), __webpack_require__(336), __webpack_require__(337)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	  } else {
